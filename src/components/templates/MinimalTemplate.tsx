    ...
    <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
      ...
      <div className="bg-gray-800 text-white p-8">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="text-xl font-semibold mt-2 opacity-80">{resumeData.targetJobRole}</h2>
      ...
      <div className="p-8">
        ...
        <section className="mb-8">
          <h3 className="text-2xl font-bold text-gray-800 border-b border-gray-300 pb-2 mb-4">
            Skills
          </h3>
